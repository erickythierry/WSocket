...
const prepareWAMessageMedia = async (message, options) => {
    ...
    if (isNewsletter) {
        ...
        if (!mediaId) {
            throw new boom_1.Boom('Newsletter media upload did not return a handle', { statusCode: 500 });
        }
 ...
 */
const generatePixButton = ({ key, keyType, merchantName, referenceId = (0, crypto_1.randomBytes)(8).toString('hex') }) => ({
    name: 'payment_info',
...
exports.generatePixButton = generatePixButton;
const generateWAMessageContent = async (message, options) => {
    ...
    if ('text' in message) {
        ...
        (_h = message.poll).selectableCount || (_h.selectableCount = 0);
        (_j = message.poll).toAnnouncementGroup || (_j.toAnnouncementGroup = false);
    ...
    if ('buttons' in message && !!message.buttons) {
    ...
    else if (('interactiveButtons' in message && !!((_a = message.interactiveButtons) === null || _a === void 0 ? void 0 : _a.length)) ||
        ('quickReplyButtons' in message && !!((_b = message.quickReplyButtons) === null || _b === void 0 ? void 0 : _b.length))) {
        if (((_c = message.interactiveButtons) === null || _c === void 0 ? void 0 : _c.length) && ((_d = message.quickReplyButtons) === null || _d === void 0 ? void 0 : _d.length)) {
            throw new boom_1.Boom('Use interactiveButtons ou quickReplyButtons, não os dois', { statusCode: 400 });
        }
        if ((_e = message.quickReplyButtons) === null || _e === void 0 ? void 0 : _e.some(button => { var _a, _b; return !((_a = button.displayText) === null || _a === void 0 ? void 0 : _a.trim()) || !((_b = button.id) === null || _b === void 0 ? void 0 : _b.trim()); })) {
            throw new boom_1.Boom('Todo quick reply precisa de displayText e id', { statusCode: 400 });
        }
        const buttons = ((_f = message.quickReplyButtons) === null || _f === void 0 ? void 0 : _f.map(button => ({
            name: 'quick_reply',
            buttonParamsJson: JSON.stringify({
        ...
        if (buttons === null || buttons === void 0 ? void 0 : buttons.some(button => button.name === 'payment_info')) {
    ...
    if ('mentions' in message && ((_g = message.mentions) === null || _g === void 0 ? void 0 : _g.length)) {
        const content = (0, exports.normalizeMessageContent)(m) || m;
...
const generateWAMessageFromContent = (jid, message, options) => {
    const newsletterMediaId = message.__newsletterMediaId;
    ...
    const result = Types_1.WAProto.WebMessageInfo.fromObject(messageJSON);
