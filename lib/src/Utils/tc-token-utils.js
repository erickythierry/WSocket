...
exports.resolvePrivacyTokenIntent = resolvePrivacyTokenIntent;
 ...
 */
function resolvePrivacyTokenIntent(params) {
    const isPlain1on1 = params.isUserDestination && !params.isGroup && !params.isStatus && !params.isNewsletter && !params.isPeer;
    if (!isPlain1on1)
        return 'none';
    if (params.isRetry) {
