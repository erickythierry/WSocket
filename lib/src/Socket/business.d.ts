...
export declare const makeBusinessSocket: (config: SocketConfig) => {
    ...
    relayMessage: (jid: string, message: import("..").proto.IMessage, { messageId: msgId, participant, additionalAttributes, additionalNodes, useUserDevicesCache, useCachedGroupMetadata, statusJidList, newsletterMediaId, isretry, excludeJids, includeJids, decryptFailHide }: import("..").MessageRelayOptions) => Promise<string>;
    ...
    createParticipantNodes: (jids: string[], message: import("..").proto.IMessage, extraAttrs?: BinaryNode['attrs'], lid?: any, meid?: any, melid?: any) => Promise<{
        nodes: BinaryNode[];
    ...
    getSelectiveSentMessage: (groupJid: string, messageId: string) => import("..").proto.IMessage | undefined;
    updateMediaMessage: (message: import("..").proto.IWebMessageInfo) => Promise<import("..").proto.IWebMessageInfo>;
    sendMessage: (jid: string, content: AnyMessageContent, options?: import("..").MiscMessageGenerationOptions) => Promise<import("..").proto.WebMessageInfo | undefined>;
    sendSecretGroupMessage: (jid: string, messageObject: AnyMessageContent, options?: import("..").SecretGroupMessageOptions) => Promise<import("..").proto.WebMessageInfo>;
    ...
    sendStatus: (content: AnyMessageContent, options: StatusMessageOptions) => Promise<import("..").proto.WebMessageInfo | undefined>;
