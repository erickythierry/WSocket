...
exports.decryptMessageNode = exports.NACK_REASONS = exports.retryReasonFor = exports.MISSING_KEYS_ERROR_TEXT = exports.NO_MESSAGE_FOUND_ERROR_TEXT = void 0;
 ...
 */
const retryReasonFor = (decryptError) => {
    if (!decryptError) {
        return undefined;
    }
...
exports.retryReasonFor = retryReasonFor;
