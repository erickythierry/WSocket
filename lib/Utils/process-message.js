    ...
    if (protocolMsg) {
        ...
        switch (message.messageStubType) {
            ...
            case Types_1.WAMessageStubType.GROUP_CHANGE_ANNOUNCE:
                const announceValue = (_j = message.messageStubParameters) === null || _j === void 0 ? void 0 : _j[0];
                emitGroupUpdate({ announce: announceValue === 'true' || announceValue === 'on' });
                break;
            case Types_1.WAMessageStubType.GROUP_CHANGE_RESTRICT:
                const restrictValue = (_k = message.messageStubParameters) === null || _k === void 0 ? void 0 : _k[0];
                emitGroupUpdate({ restrict: restrictValue === 'true' || restrictValue === 'on' });
                break;
            case Types_1.WAMessageStubType.GROUP_CHANGE_SUBJECT:
                const name = (_l = message.messageStubParameters) === null || _l === void 0 ? void 0 : _l[0];
                chat.name = name;
                emitGroupUpdate({ subject: name });
                break;
            case Types_1.WAMessageStubType.GROUP_CHANGE_DESCRIPTION:
                const description = (_m = message.messageStubParameters) === null || _m === void 0 ? void 0 : _m[0];
                chat.description = description;
                emitGroupUpdate({ desc: description });
                break;
            case Types_1.WAMessageStubType.GROUP_CHANGE_INVITE_LINK:
                const code = (_o = message.messageStubParameters) === null || _o === void 0 ? void 0 : _o[0];
                emitGroupUpdate({ inviteCode: code });
                break;
            case Types_1.WAMessageStubType.GROUP_MEMBER_ADD_MODE:
                const memberAddValue = (_p = message.messageStubParameters) === null || _p === void 0 ? void 0 : _p[0];
                emitGroupUpdate({ memberAddMode: memberAddValue === 'all_member_add' });
                break;
            case Types_1.WAMessageStubType.GROUP_MEMBERSHIP_JOIN_APPROVAL_MODE:
                const approvalMode = (_q = message.messageStubParameters) === null || _q === void 0 ? void 0 : _q[0];
                emitGroupUpdate({ joinApprovalMode: approvalMode === 'on' });
                break;
            case Types_1.WAMessageStubType.GROUP_MEMBERSHIP_JOIN_APPROVAL_REQUEST_NON_ADMIN_ADD:
                const participant = (_r = message.messageStubParameters) === null || _r === void 0 ? void 0 : _r[0];
                const action = (_s = message.messageStubParameters) === null || _s === void 0 ? void 0 : _s[1];
                const method = (_t = message.messageStubParameters) === null || _t === void 0 ? void 0 : _t[2];
