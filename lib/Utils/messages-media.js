...
const encryptedStream = async (media, mediaType, { logger, saveOriginalFileIfRequired, opts } = {}) => {
    ...
    try {
        ...
        const encFileFinished = (0, events_1.once)(encFileWriteStream, 'finish');
        const originalFileFinished = originalFileStream ? (0, events_1.once)(originalFileStream, 'finish') : Promise.resolve();
        ...
        (_a = originalFileStream === null || originalFileStream === void 0 ? void 0 : originalFileStream.destroy) === null || _a === void 0 ? void 0 : _a.call(originalFileStream);
        aes.destroy();
        hmac.destroy();
        sha256Plain.destroy();
        sha256Enc.destroy();
...
const getWAUploadToServer = ({ customUploadHosts, fetchAgent, logger, options }, refreshMediaConn) => {
    return async (filePath, { mediaType, fileEncSha256B64, timeoutMs, newsletter }) => {
        ...
        for (const { hostname } of hosts) {
            ...
            const defaultPath = Defaults_1.MEDIA_PATH_MAP[mediaType];
            const mediaName = defaultPath === null || defaultPath === void 0 ? void 0 : defaultPath.split('/').filter(Boolean).at(-1);
            if (!defaultPath || (newsletter && !mediaName)) {
                throw new boom_1.Boom(`Unsupported media type for upload: ${mediaType}`, { statusCode: 400 });
            }
            ...
            try {
                const body = await axios_1.default.post(url, (0, fs_1.createReadStream)(filePath), {
                    ...
                    headers: {
                        ...
                        Origin: Defaults_1.DEFAULT_ORIGIN,
                        Referer: `${Defaults_1.DEFAULT_ORIGIN}/`
                    },
                ...
                result = body.data;
                const hasMediaLocation = (result === null || result === void 0 ? void 0 : result.url) || (result === null || result === void 0 ? void 0 : result.direct_path) || (result === null || result === void 0 ? void 0 : result.directPath);
                if (hasMediaLocation && (!newsletter || (result === null || result === void 0 ? void 0 : result.handle))) {
                    urls = {
                        mediaUrl: result.url,
