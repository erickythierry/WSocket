...
function makeLibSignalRepository(auth) {
    ...
    const migrateSessionIfNeeded = async (lidJid, pnJid) => {
        var _a, _b;
        const pnUser = (_a = (0, WABinary_1.jidDecode)(pnJid)) === null || _a === void 0 ? void 0 : _a.user;
        if (!pnUser) {
            return;
        }
        ...
        const device = ((_b = (0, WABinary_1.jidDecode)(lidJid)) === null || _b === void 0 ? void 0 : _b.device) || 0;
    ...
    return {
        ...
        async decryptMessage({ jid, type, ciphertext, pnJid }) {
            if (pnJid && (0, WABinary_1.isLidUser)(jid)) {
