...
const makeMessagesSocket = (config) => {
    ...
    const relayMessage = async (jid, message, { messageId: msgId, participant, additionalAttributes, additionalNodes, useUserDevicesCache, useCachedGroupMetadata, statusJidList, isretry, excludeJids, includeJids, decryptFailHide }) => {
        var _a, _b, _c;
        ...
        sendMessage: async (jid, content, options = {}) => {
            ...
            if (typeof content === 'object' &&
                ...
                await relayMessage(jid, fullMsg.message, {
                    ...
                    useCachedGroupMetadata: ((_d = options.includeJids) === null || _d === void 0 ? void 0 : _d.length) || ((_e = options.excludeJids) === null || _e === void 0 ? void 0 : _e.length)
                        ? false
                        : options.useCachedGroupMetadata,
                    useUserDevicesCache: ((_f = options.includeJids) === null || _f === void 0 ? void 0 : _f.length) || ((_g = options.excludeJids) === null || _g === void 0 ? void 0 : _g.length)
                        ? false
