...
const makeMessagesRecvSocket = (config) => {
    ...
    const { ev, authState, ws, processingMutex, signalRepository, query, upsertMessage, resyncAppState, onUnexpectedError, assertSessions, sendNode, relayMessage, getUSyncDevices, getSelectiveRelayContext, getSelectiveSentMessage, sendReceipt, uploadPreKeys, sendPeerDataOperationMessage } = sock;
        ...
        switch (nodeType) {
                            ...
                            await authState.keys.set({
                                'contacts-tc-token': {
                                    [storageJid]: {
                                        ...
                                        token: content,
                                        timestamp: attrs.t,
                                        senderTimestamp: (_a = existingEntry === null || existingEntry === void 0 ? void 0 : existingEntry.senderTimestamp) !== null && _a !== void 0 ? _a : issueTimestamp
                                    }
                                }
                            });
                        }
            ...
            case 'picture':
                ...
                ev.emit('contacts.update', [
                    {
                        id: (0, WABinary_1.jidNormalizedUser)((_b = node === null || node === void 0 ? void 0 : node.attrs) === null || _b === void 0 ? void 0 : _b.from) || ((_d = (_c = (setPicture || delPicture)) === null || _c === void 0 ? void 0 : _c.attrs) === null || _d === void 0 ? void 0 : _d.hash) || '',
    ...
    const handleBadAck = async ({ attrs }) => {
        ...
        if (attrs.error) {
            if (attrs.error === Defaults_1.SERVER_ERROR_CODES.MissingTcToken) {
                ...
                const jid = (0, WABinary_1.jidNormalizedUser)(attrs.from);
